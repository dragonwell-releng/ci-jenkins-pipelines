class Config17 {
  final Map<String, Map<String, ?>> buildConfigurations = [
        ...
        x64Linux  : [
                ...
                test                : 'default',
                buildArgs    : [
                                ajdk: '--gradle-user-home-dir /root/.gradle --jdk-boot-dir /usr/lib/jvm/jdk-17'
                        ],
                configureArgs       : [
        ...
        x64Windows: [
                ...
                buildArgs: '--jvm-variant client,server',
                test                : 'default'
        ],
        ...
        aarch64Linux    : [
                os                  : 'linux',
                arch                : 'aarch64',
                dockerImage         : 'reg.docker.alibaba-inc.com/ajdk/centos7_build_image',
                test                : 'default',
